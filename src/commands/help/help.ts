...
import createSelection from "../../utilities/discord/createSelection";
import Command from "../../types/Command";
import { capitalizeFirstLetter } from "../../utilities/oneLiners";
...
const help = {
	...
	callback: async ({ channel, instance, member, interaction }) => {
		...
		const menu = createSelection(message, options);
